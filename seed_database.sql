...
INSERT INTO members (id, first_name, last_name, email, phone, gender, birth_date, membership_type, start_date, status, notes, created_at, updated_at) VALUES
  ...
  (gen_random_uuid(), 'Layla', 'Bouazizi', 'layla.b@example.com', '0667890123', 'female', '1993-04-17', 'premium'::membership_type, '2024-02-05', 'active'::member_status, 'Prefers evening sessions', NOW(), NOW()),
  (gen_random_uuid(), 'Omar', 'Benjelloun', 'omar.b@example.com', '0678901234', 'male', '1987-11-09', 'platinum'::membership_type, '2023-07-12', 'active'::member_status, 'Professional athlete', NOW(), NOW()),
  (gen_random_uuid(), 'Nadia', 'El Fassi', 'nadia.elfassi@example.com', '0689012345', 'female', '1991-02-25', 'basic'::membership_type, '2024-03-01', 'active'::member_status, 'New member, first-time gym user', NOW(), NOW()),
  (gen_random_uuid(), 'Hassan', 'Chraibi', 'hassan.c@example.com', '0690123456', 'male', '1989-09-14', 'premium'::membership_type, '2023-12-10', 'active'::member_status, 'Focuses on weight training', NOW(), NOW()),
  (gen_random_uuid(), 'Samira', 'Ziani', 'samira.z@example.com', '0601234567', 'female', '1994-06-30', 'basic'::membership_type, '2024-01-25', 'active'::member_status, 'Interested in nutrition advice', NOW(), NOW());
...
BEGIN
  ...
  INSERT INTO staff (id, first_name, last_name, email, phone, role, hire_date, status, notes, created_at, updated_at) VALUES
    ...
    (gen_random_uuid(), 'Leila', 'Haddad', 'leila.h@gym.com', '0745678901', 'receptionist'::staff_role, '2022-08-05', 'active'::staff_status, 'Front desk, morning shift', NOW(), NOW()),
    (gen_random_uuid(), 'Hamid', 'Ouazzani', 'hamid.o@gym.com', '0756789012', 'maintenance'::staff_role, '2022-10-12', 'active'::staff_status, 'Equipment maintenance', NOW(), NOW());
  ...
  LOOP
    ...
    VALUES (
      ...
      member_id,
      (CASE
        WHEN (SELECT membership_type FROM members WHERE id = member_id) = 'basic' THEN 200.00
        WHEN (SELECT membership_type FROM members WHERE id = member_id) = 'premium' THEN 350.00
        ELSE 500.00
      END),
      NOW() - INTERVAL '5 days',
